...
function submitFormulario(event) {
    ...
    console.log("Nome:", event.srcElement[0].value)
    console.log("Data:", event.srcElement[1].value)
    console.log("Email:", event.srcElement[2].value)
    console.log("Senha:", event.srcElement[3].value)
